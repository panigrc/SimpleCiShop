<p><?php echo anchor("admin/catalog/view_product/add_product", '<img src="'. base_url() .'/theme/images/add2.png" alt="Προσθήκη Προϊόντος" align="middle"> Προσθήκη Προϊόντος', 'Προσθήκη Προϊόντος'); ?></p>
...
<?php foreach($products as $product): ?>
    <tr class="<?php if(@$style === 'odd'){ echo 'even'; $style='even';} else{ echo 'odd'; $style='odd'; } ?>">
        ...
        <td>
            ...
            <a href="#" onclick="<?php echo $this->ajax->remote_function(array('update'=>'stock'.$product['product_id'], 'url'=>site_url("admin/catalog/ajax_set_stock/" . $product['product_id'] . "/". (1) ))); ?>; return FALSE;">+1</a>
            <a href="#" onclick="<?php echo $this->ajax->remote_function(array('update'=>'stock'.$product['product_id'], 'url'=>site_url("admin/catalog/ajax_set_stock/" . $product['product_id'] . "/". (-1) ))); ?>; return FALSE;">-1</a>
        </td>
        ...
        <td><?php echo anchor("admin/catalog/delete_product/".$product['product_id'], '<img src="'. base_url() .'/theme/images/delete2.png" alt="'.$this->lang->line('main_delete').'">', array('title' => $this->lang->line('main_delete'), 'onclick' => 'if( ! confirm(\'Θελετε σίγουρα να διαγραφεί η εγγραφή;\')) return FALSE;')); ?></td>
    </tr>
<?php endforeach; ?>
</table>
