...
<?php foreach($coupons as $coupon): ?>
    <tr class="<?php if(@$style === 'odd'){ echo 'even'; $style='even';} else{ echo 'odd'; $style='odd'; } ?>">
        ...
        <td><?php echo anchor("coupon/delete_coupon/".$coupon['coupon_id'], '<img src="'. base_url() .'/theme/images/delete2.png" alt="'.$this->lang->line('main_delete').'">', array('title' => $this->lang->line('main_delete'), 'onclick' => 'if( ! confirm(\'Θελετε σίγουρα να διαγραφεί η εγγραφή;\')) return FALSE;')); ?></td>
    </tr>
<?php endforeach; ?>
</table>
