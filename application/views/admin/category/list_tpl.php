...
<p>
    <?php echo anchor("category/view_category/add_category", '<img src="' . base_url() . '/theme/images/add2.png" alt="Προσθήκη Νέου" align="middle"> Προσθήκη Κατηγορίας', 'Προσθήκη Κατηγορίας'); ?>
</p>
