...
<?php foreach($products as $product): ?>
					    <div class="item">
                            ...
                            <a href="<?php echo site_url('/shop/product/index/'.$lang.'/'.$product['nicename']) ?>"><img src="<?php echo empty($product['thumb']) === FALSE ? base_url().$product['thumb'] : base_url().'images/noimage.jpg' ; ?>" class="cart_product" id="product_<?php echo $product['productID']; ?>" alt="<?php echo $product['title_'.$lang]; ?>" /></a>
